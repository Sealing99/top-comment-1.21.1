...
public class TenThousandTntEntityRenderer extends EntityRenderer<TenThousandTntEntity> {
    private final BlockRenderManager blockRenderManager;

    public TenThousandTntEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
        this.shadowRadius = 0.5F;
        this.blockRenderManager = context.getBlockRenderManager();
    }

    public void render(TenThousandTntEntity tntEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        matrixStack.push();
    ...
    public Identifier getTexture(TenThousandTntEntity tntEntity) {
